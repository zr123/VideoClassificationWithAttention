# This file has been changed from the original TensorFlow Authors
#
#
...
def MobileNetV2(input_shape=None,
  ...
  if attention_builder_fn is not None:
      x = attention_builder_fn(x, filters=24, shortcuts=2, name="attn1")
  ...
  if attention_builder_fn is not None:
      x = attention_builder_fn(x, filters=32, shortcuts=1, name="attn2")
  ...
  if attention_builder_fn is not None:
      x = attention_builder_fn(x, filters=96, shortcuts=0, name="attn3")
